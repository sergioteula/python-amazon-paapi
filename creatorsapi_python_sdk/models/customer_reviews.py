...
class CustomerReviews(BaseModel):
    ...
    star_rating: Optional[Rating] = Field(default=None, alias="starRating")
    __properties: ClassVar[List[str]] = ["count", "starRating"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of star_rating
        if self.star_rating:
            _dict['starRating'] = self.star_rating.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "starRating": Rating.from_dict(obj["starRating"]) if obj.get("starRating") is not None else None
        })
        return _obj
