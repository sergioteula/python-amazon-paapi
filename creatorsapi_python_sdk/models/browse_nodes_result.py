...
class BrowseNodesResult(BaseModel):
    ...
    """ # noqa: E501
    browse_nodes: Optional[List[BrowseNode]] = Field(default=None, description="Container for BrowseNode information which includes BrowseNodeId, Name, Ancestor, Children, SalesRank associated, etc.", alias="browseNodes")
    __properties: ClassVar[List[str]] = ["browseNodes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BrowseNodesResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BrowseNodesResult from a dict"""
        if obj is None:
            return None
