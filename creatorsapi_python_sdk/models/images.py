...
class Images(BaseModel):
    ...
    """ # noqa: E501
    primary: Optional[ImageType] = None
    variants: Optional[List[ImageType]] = Field(default=None, description="List of image type which identifies a image as Primary and Variant. Primary denotes the image which is displayed in search results and on the detail page. Variant includes everything else.")
    __properties: ClassVar[List[str]] = ["primary", "variants"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "primary": ImageType.from_dict(obj["primary"]) if obj.get("primary") is not None else None,
            "variants": [ImageType.from_dict(_item) for _item in obj["variants"]] if obj.get("variants") is not None else None
        })
        return _obj
