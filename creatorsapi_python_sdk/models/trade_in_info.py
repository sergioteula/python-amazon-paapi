...
class TradeInInfo(BaseModel):
    ...
    price: Optional[TradeInPrice] = None
    __properties: ClassVar[List[str]] = ["isEligibleForTradeIn", "price"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "price": TradeInPrice.from_dict(obj["price"]) if obj.get("price") is not None else None
        })
        return _obj
